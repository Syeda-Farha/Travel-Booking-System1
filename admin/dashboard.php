							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editstatus.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['transactionum'].'" class="delbutton" title="Click To Delete">delete</a> | <a href="../print.php?id='.$row['transactionum'].'">print</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
