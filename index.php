...
<body style="background-image:url(xres/images/pic1.png)">
<div id="wrapper">
	<div id="header">
    <a href="index.php"><img src="xres/images/MYLOGO.png" class="logo"  STYLE="border-radius:80%" /></a>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="xres/images/jb2/pic5.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/pic8.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/pic3.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="xres/images/jb2/pic9.jpg" width="861" height="379"  alt="" /></li>
              </ul>
   ...
   <div id="featured">
        <div id="items">
            <div class="item"> <img src="xres/images/pic10.jpg" alt="" />
            <h3>Specials Offers</h3>
            <p><strong>Aircon Bus</strong><br />
			Come in and experience<br /> Our
			new Bus Type<br /> specials today!</p>  
            </div>
            <div class="item"> <img src="xres/images/pic13.jpg" alt="" />
            <h3>New Route</h3>
            <p><strong>From Satara To Parbhani</strong><br />
			By The New Route.</p>  
			</div>
	...
	<div id="footer">
	<h4 style=";"> PHOENIX TRAVELS &bull; (+91989889898)</h4>
	<p style=";">Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
